...
void main() => runApp(const BlueFinanceApp());

class BlueFinanceApp extends StatelessWidget {
  const BlueFinanceApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Simulador Azul',
      theme: ThemeData(
...
class _FinanceScreenState extends State<FinanceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Simulador Azul'),
